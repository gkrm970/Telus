...
class Bus(BaseModel):
    ...
    kafka_host: Optional[str] = Field(None, description='message bus host name (leaf)')
    ...
    #kafka_auth_type_id: Optional[int] = Field(
    #    None, description='Associated Kafka authentication id after insterting into auth_type table'
    #)
    ...
    #)
    #topics: Optional[List[Topic]] = Field(None, description='(list)')
    #schema_registry: Optional[SchemaRegistry] = Field(
